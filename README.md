...
- **Default**: Uses external database (built-in PostgreSQL disabled)
- **Built-in**: Use `--with-db` flag or set `ENABLE_SUPABASE_DB=true` in `docker/.env`

For detailed database configuration options, see [docker/README-DATABASE.md](docker/README-DATABASE.md).
