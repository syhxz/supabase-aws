...
import { EnhancedDatabaseConnectionString } from 'components/interfaces/Connect/EnhancedDatabaseConnectionString'
              ...
              return (
                ...
                >
                  <div className={DIALOG_PADDING_Y}>
                    {/* Use enhanced version when project has specific database user */}
                    {(selectedProject as any)?.database_user ? (
                      <EnhancedDatabaseConnectionString />
                    ) : (
