...
// Extended type to include database user information
type ProjectWithDatabaseUser = OrgProject & { database_user?: string }

export interface ProjectTableRowProps {
  project: ProjectWithDatabaseUser
        ...
        <div className="flex flex-col gap-y-1">
          <div>
            ...
            {project.database_user && (
              <p className="text-xs text-foreground-lighter">User: @{project.database_user}</p>
            )}
          </div>
