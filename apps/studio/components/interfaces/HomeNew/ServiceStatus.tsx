...
import { safeFind } from 'lib/array-validation'
...
export const ServiceStatus = () => {
  ...
  const authStatus = safeFind(status, (service) => service.name === 'auth')
  const restStatus = safeFind(status, (service) => service.name === 'rest')
  const realtimeStatus = safeFind(status, (service) => service.name === 'realtime')
  const storageStatus = safeFind(status, (service) => service.name === 'storage')
  const dbStatus = safeFind(status, (service) => service.name === 'db')
