...
export const JWTSecretKeysTable = () => {
  ...
  return (
    <>
      ...
      {sortedKeys.length > 0 && (
        <>
          <div className="mb-4 p-4 bg-surface-75 border rounded-md">
            <div className="flex items-start gap-3">
              <div className="flex-shrink-0 mt-0.5">
                <AlertCircle size={16} className="text-foreground-light" />
              </div>
              <div className="flex-1">
                <h4 className="text-sm font-medium text-foreground mb-1">
                  JWT Signing Keys - Metadata Only
                </h4>
                <p className="text-sm text-foreground-light mb-2">
                  This table shows signing key metadata (ID, algorithm, status) for security reasons. 
                  Private keys are never displayed. For API access keys with reveal functionality, visit the API Keys section.
                </p>
                <div className="flex gap-2">
                  ...
                  {legacyKey && (
                    <Button type="default" size="tiny" asChild>
                      <Link href={`/project/${projectRef}/settings/jwt`}>
                        View Legacy JWT Secret
                      </Link>
                    </Button>
                  )}
                </div>
