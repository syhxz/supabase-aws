...
export const DatabasePasswordInput = ({
  ...
  // Use environment variable password if available (for self-hosted)
  function useEnvPassword() {
    const envPassword = process.env.NEXT_PUBLIC_POSTGRES_PASSWORD || process.env.POSTGRES_PASSWORD
    if (envPassword) {
      form.setValue('dbPass', envPassword)
      checkPasswordStrength(envPassword)
    }
  }
              ...
              description={
                <>
                  ...
                  <p className="text-xs text-foreground-lighter mt-2">
                    This password will be used for your project's dedicated database user. 
            ...
            >
              <FormControl_Shadcn_>
                <Input
                  ...
                  type="password"
                  placeholder="Enter a strong password for your database user"
                  {...field}
                  autoComplete="off"
