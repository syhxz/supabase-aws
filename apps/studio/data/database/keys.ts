export const databaseKeys = {
  ...
  poolingStatistics: (projectRef: string | undefined) =>
    ['projects', projectRef, 'database', 'pooling-statistics'] as const,
  poolingHealth: (projectRef: string | undefined) =>
    ['projects', projectRef, 'database', 'pooling-health'] as const,
  poolingUnified: (projectRef: string | undefined) =>
    ['projects', projectRef, 'database', 'pooling-unified'] as const,
  ...
  supavisorConfig: (projectRef: string | undefined) =>
    ['projects', projectRef, 'supavisor', 'config'] as const,
  supavisorStats: (projectRef: string | undefined) =>
    ['projects', projectRef, 'supavisor', 'stats'] as const,
  supavisorHealth: (projectRef: string | undefined) =>
    ['projects', projectRef, 'supavisor', 'health'] as const,
  supavisorRecommendations: (projectRef: string | undefined) =>
    ['projects', projectRef, 'supavisor', 'recommendations'] as const,
  supavisorBackups: (projectRef: string | undefined) =>
    ['projects', projectRef, 'supavisor', 'backups'] as const,
  dockerContainers: (
    projectRef: string | undefined,
    container?: string,
    action?: string
  ) => ['projects', projectRef, 'docker-containers', container, action] as const,
  poolingServiceDetection: (projectRef: string | undefined) =>
    ['projects', projectRef, 'database', 'pooling-service-detection'] as const,
