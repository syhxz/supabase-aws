...
exports.CredentialMonitoringDatabase = void 0;
exports.createCredentialMonitoringDatabase = createCredentialMonitoringDatabase;
const supabase_js_1 = require("@supabase/supabase-js");
/**
 * Database adapter for credential monitoring operations
 */
class CredentialMonitoringDatabase {
    constructor(config) {
     ...
     */
    async cleanupOldAuditLogs(olderThanDays = 180) {
     ...
     */
    async getRecentFallbackUsageByProjects(projectRefs, limit = 10) {
     ...
     */
    async insertAuditLogBatch(entries) {
        if (entries.length === 0) {
            return [];
        }
        const { data, error } = await this.supabase
