...
exports.EnhancedDatabaseTypeIdentifier = void 0;
exports.createDatabaseTypeIdentifier = createDatabaseTypeIdentifier;
exports.isSimplePrimaryDatabase = isSimplePrimaryDatabase;
exports.getDatabaseTypeLabel = getDatabaseTypeLabel;
/**
 ...
 */
class EnhancedDatabaseTypeIdentifier {
     ...
     */
    identifyDatabaseType(projectRef, databaseId) {
    ...
    hasReplicaIndicators(database) {
        ...
        return replicaPatterns.some(pattern => identifier.includes(pattern) || region.includes(pattern));
    }
    /**
     * Determines if this is a remote database (not local Docker)
     */
    isRemoteDatabase(database) {
     ...
     */
    isMainDatabaseInstance(database, projectRef) {
     ...
     */
    extractDatabaseName(database, projectRef) {
        // Treat empty strings as missing values
     ...
     */
    extractUser(database, isPrimary) {
        // Treat empty strings as missing values
...
exports.EnhancedDatabaseTypeIdentifier = EnhancedDatabaseTypeIdentifier;
/**
 * Creates a new database type identifier instance
 */
function createDatabaseTypeIdentifier(databases = []) {
 ...
 */
function isSimplePrimaryDatabase(projectRef, databaseId) {
    return databaseId === projectRef;
}
/**
 * Utility function to get database type label for UI display
 */
function getDatabaseTypeLabel(projectRef, databaseId, databases = []) {
