...
const nextConfig = {
  ...
  async redirects() {
    return [
      ...(process.env.NEXT_PUBLIC_IS_PLATFORM === 'true'
        ...
        : [
            // Self-hosted mode: redirect to organizations page instead of /project/default
            {
              source: '/',
  ...
  webpack(config, { isServer }) {
    ...
    if (!isServer) {
      ...
      // Ignore specific self-hosted modules on client side
      config.resolve.alias = {
        ...config.resolve.alias,
        'lib/api/self-hosted/project-store$': false,
        'lib/api/self-hosted/project-store-pg$': false,
        'lib/api/self-hosted/enhanced-credential-generation$': false,
        'lib/api/self-hosted/credential-migration-manager$': false,
        'lib/api/self-hosted/database-user-manager$': false,
        'lib/api/self-hosted/database-manager$': false,
        'lib/api/self-hosted/query$': false,
        'lib/api/self-hosted/pg-meta-pool-manager$': false,
      }
    }
