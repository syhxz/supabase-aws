...
/**
 * API endpoint for advisor data with project isolation and security
 * 
 * GET /api/platform/projects/[ref]/advisor - Get advisor data for project (requires read permission)
 * POST /api/platform/projects/[ref]/advisor - Create new advisor data (requires write permission)
 * PATCH /api/platform/projects/[ref]/advisor - Resolve advisor recommendations (requires write permission)
 * 
