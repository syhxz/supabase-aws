...
/**
 * API endpoint for analytics log drains with project isolation
 * 
 * GET /api/platform/projects/[ref]/analytics/log-drains - List log drains
 * POST /api/platform/projects/[ref]/analytics/log-drains - Create log drain
 * 
 * Requirements: 2.5
 */
