...
/**
 * API endpoint for log data with project isolation and security
 * 
 * GET /api/platform/projects/[ref]/logs - Get log data for project (requires read permission)
 * POST /api/platform/projects/[ref]/logs - Create new log data (requires write permission)
 * 
