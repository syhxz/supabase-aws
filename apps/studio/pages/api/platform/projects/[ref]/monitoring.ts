...
/**
 * API endpoint for monitoring data with project isolation and security
 * 
 * GET /api/platform/projects/[ref]/monitoring - Get monitoring data for project (requires read permission)
 * POST /api/platform/projects/[ref]/monitoring - Create new monitoring data (requires write permission)
 * 
