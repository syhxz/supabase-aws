...
After setting up your self-hosted Supabase instance, you'll need to create admin users to access Studio:
...
- Create the user via GoTrue API
- Display the user ID and confirmation status

### Alternative Methods

**Using GoTrue API directly:**
```bash
...
INSERT INTO auth.users (
  ...
  crypt('your-password', gen_salt('bf')), now(), now(), now(), now()
);
```

For detailed user management instructions, see:
- **[USER-MANAGEMENT.md](../docs/USER-MANAGEMENT.md)** - Complete user management guide
- **[ENABLE-LOGIN.md](../ENABLE-LOGIN.md)** - Authentication setup guide
